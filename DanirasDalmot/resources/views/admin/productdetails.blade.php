...
@section('content')
    ...
    <!-- Modal for delete  -->
    <div class="modal fade" id="productdeletemodal" aria-labelledby="Title" aria-hidden="true">
        ...
        <div class="product-main">
            ...
            <div class="product-details">
                    ...
                    <div class="row">
                            ...
                            <p>In Stock :
                                <label class="switch ml-2">
                                    <input type="checkbox" name="stock" id="{{ $product->id }}"
                                        product_id="{{ $product->id }}" value="{{ $product->in_stock }}"
                                        class="toggle__input" @if ($product->in_stock) checked @endif />
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Show In Home : <label class="switch ml-2">
                                    ...
                                    <input type="checkbox" id="{{ $product->id }}" name="home"
                                        product_id="{{ $product->id }}" value="{{ $product->home }}"
                                        class="toggle__input" @if ($product->home) checked @endif />
                ...
                <div class="images codes">
                    <div class="bar-code">
                        <p class="det"><span>Bar-Code : <a href="{{ route('qrcode.download', $product->id) }}"
                                    role="button" class="btn download" data-toggle="tooltip" data-placement="top"
                                    title="Download bar code">
                        ...
                        @else
                            ...
                            <img src="{{ $product->bar_path }}" alt="team" class="img-fluid" />
                        @endif
                    </div>
                    <div class="qr-code">
                        <p class="det"><span>Qr-Code : <a href="{{ route('qrcode.download', $product->id) }}"
                                    class="btn download" role="button" data-toggle="tooltip" data-placement="top"
                        ...
                        @else
                            ...
                            <img src="{{ $product->qr_path }}" alt="team" class="img-fluid" />
                        @endif
                    </div>
                </div>
