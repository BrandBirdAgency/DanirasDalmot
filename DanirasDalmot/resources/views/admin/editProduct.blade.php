...
@section('content')
    ...
    <div class="container" id="add-product-container">
        <div class="card" id="add-product-card">
            ...
            <form class="card-body add-product-body" method="POST" action={{ route('product.update', ['id' => $product->id]) }}
                ...
                <div class="row">
                    <div class="col-md-4 col-12">
                        ...
                        <div class="form-group">
                            ...
                            <select id="inp" class="form-control form-control-sm" name="category">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
