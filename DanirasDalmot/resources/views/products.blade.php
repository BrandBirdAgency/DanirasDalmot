                        ...
                        <div class="share-product">
                            ...
                            <div class="icons">
                                <div class="fb-share-button"
                                    data-href="https://danirasdalmoth.com/products/{{ $p->id }}"
                                ...
                                <a target="_blank" href="https://twitter.com/share?ref_src=twsrc%5Etfw"
                                    ...
                                    data-url="https://danirasdalmoth.com/products/{{ $p->id }}"
                                    ...
                                    <form action={{ route('productorder') }} method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="number" class="form-control" id="WardNo" name="ward_no"
                                                    required />
                                                @error('ward_no')
                                                    <div class="text-danger small">{{ $message }}</div>
                                                @enderror
