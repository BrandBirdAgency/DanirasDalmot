...
@section('meta_desc', 'Contact Danira\'s Dalmoth for bulk orders, wholesale inquiries, or product information. Order
authentic Nepali dalmoth and namkeen online. Fast delivery across Nepal. Call us or send your inquiry today!')
@section('meta_keywords', 'contact Danira\'s Dalmoth, order dalmoth online, bulk namkeen orders Nepal, wholesale
dalmoth, buy namkeen Nepal, dalmoth delivery Nepal, namkeen supplier contact')
                    ...
                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="phone"
                                                    value="{{ old('phone') }}" id="phone" placeholder="Phone" />
                                            </div>
                                            @error('phone')
                                            {{ $message }}
                                            @enderror
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $about->name }}" id="name" name="name" />
                                                                @error('name') {{ $message }} @enderror
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="address">Address:</label>
                                                                <input type="text" class="form-control"
                                                                    value="{{ $about->address }}" id="address"
                                                                    name="address" />
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $about->website }}" id="website"
                                                                    name="website" />
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $about->facebook }}" id="facebook"
                                                                    name="facebook" />
                                                                @error('website') {{ $message }} @enderror
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $about->instagram }}" id="instagram"
                                                                    name="instagram" />
                                                                @error('website') {{ $message }} @enderror
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $about->twitter }}" id="twitter"
                                                                    name="twitter" />
                                                                @error('website') {{ $message }} @enderror
                                                            </div>
                                                        </div>
                          ...
                          ">
                                    ...
                                    <div class="text pl-3">
                                        <p>
                                            <a href="mailto:{{ $about->email }}" class="text-dark">{{ $about->email
                                                }}</a>
                                        </p>
                                    </div>
                                </div>
                          ...
                          ">
                                    ...
                                    <div class="text pl-3">
                                        <p>
                                            <a target="_blank" href="{{ $about->website }}" class="text-dark">{{
                                                $about->website }}</a>
                                        </p>
                                    </div>
                                </div>
