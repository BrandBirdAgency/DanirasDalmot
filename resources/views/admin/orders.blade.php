                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-center align-items-center">
                                    <label class="form-check-label" for="{{ $order->id }}">
                                        <input type="checkbox" id="{{ $order->id }}" name="stat"
                                            order_id="{{ $order->id }}" value="{{ $order->status }}"
                                            class="form-check-input" @if ($order->status) checked @endif />
                                    </label>
                                </td>
