        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('product.delete', ['id' => $product->id]) }}" class="btn btn-danger">Delete Product</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="detail-row">
                                ...
                                <div class="form-check form-switch d-inline-block ms-3">
                                    <input class="form-check-input" type="checkbox" name="stock" id="stock-{{ $product->id }}" 
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="code-section">
                                        ...
                                        @endif
                                        <a href="{{ route('qrcode.download', $product->id) }}" class="btn btn-sm btn-outline-primary mt-2">
