    ...
    <div class="product-main">
      ...
      <div class="product-details">
        ...
        <div class="share-product">
          <p>Share on</p>
          <div class="icons">
            <div class="fb-share-button" data-href="https://danirasdalmoth.com/products/{{$p->id}}" data-layout="button"
            ...
            <a target="_blank" href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button"
              data-text="{{$p->description}}" data-url="https://danirasdalmoth.com/products/{{$p->id}}"
