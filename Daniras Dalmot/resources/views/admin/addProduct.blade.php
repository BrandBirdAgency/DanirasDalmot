      ...
      <div class="row">
        <div class="col-md-4 col-12">
          <div class="form-group">
            ...
            <input type="text" id="inp" class="form-control form-control-sm" name="name" required />
            @error('name')
            {{$message}}
            @enderror
          </div>
            ...
            <div class="row">
              <div class="col-md-4 col-12">
                <div class="form-group">
                  ...
                  <input type="text" id="inp" class="form-control form-control-sm" name="name"
                    value="{{ old('name')}}" />
                  @error('name')
                  {{$message}}
                  @enderror
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="inp" class="form-control form-control-sm" name="size"
              ...
              <div class="col-md-4 col-12">
                ...
                <div class="form-group">
                  ...
                  <input type="number" id="inp" class="form-control form-control-sm" name="price"
              ...
              <div class="col-md-4 col-12">
                <div class="form-group">
                  ...
                  <input type="text" id="inp" class="form-control form-control-sm" name="brand_name" required />
                  @error('brand_name')
                  {{$message}}
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input type="number" id="inp" class="form-control form-control-sm" name="retail_price" required />
                  @error('retail_price')
                  {{$message}}
                  @enderror
                </div>
                <div class="form-group">
                  <label for="inouttextarea">Price</label>
                  <input type="number" id="inp" class="form-control form-control-sm" name="price" required />
                  @error('price')
                  {{$message}}
                  @enderror
                </div>
                ...
                <<<<<<< HEAD <div class="form-group">
                  <label for="inouttextarea">Discount</label>
                  <input type="number" id="inp" class="form-control form-control-sm" name="discount" required />
                  @error('discount')
                  {{$message}}
                  @enderror
              </div>
              ...
              <div class="col-md-4 col-12 text-left">
                ...
                <div class="form-group">
                  ...
                  <div class="upload">
                    ...
                    >>>>>>> ef79fb2110aaa5e7eb0209ac4f64f10466036ba7

                    <div class="form-group">
                      <label for="inputfile" class="">Product Image </label>
                      <div class="upload">
                        <input type="file" name='photo' accept="image/*" id="real-file0" hidden="hidden" required />
                        <button type="button" id="custom-button0" class="btn">
                          Choose an image
                        </button>
                        <p id="custom-text0">No file chosen, yet.</p>
