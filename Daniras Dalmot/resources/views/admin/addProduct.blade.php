      ...
      <div class="row">
        <div class="col-md-4 col-12">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="inputtextarea" rows="3" name="description" required></textarea>
            @error('description')
            {{$message}}
            @enderror
          </div>
          <div class="form-group">
            ...
            <select id="inp" class="form-control form-control-sm" name="category" required>
              <option>1</option>
              <option>2</option>
              <option>3</option>
              <option>4</option>
          ...
          <div class="form-group">
            ...
            <input type="text" id="inp" class="form-control form-control-sm" name="size" required />
            @error('size')
            {{$message}}
            @enderror
          </div>
