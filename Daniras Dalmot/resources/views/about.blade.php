                    ...
                    <div class="main">
                        <div class="head">
                            <lord-icon src="https://cdn.lordicon.com/tyounuzx.json" trigger="loop" delay="100"
                                colors="primary:#e83225,secondary:#e83225" stroke="85" scale="56"
                                style="width: 60px; height: 60px" class="icon">
                            </lord-icon>
            ...
            <div class="row mx-0 px-0">
                ...
                <div class="col-md-6">
                    <div class="whyus">
                        <h2>Why Choose Us ?</h2>
                        <div class="line"></div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. A perspiciatis distinctio quis
                            repellendus doloremque quisquam quasi quas architecto maiores. Sunt ipsa velit culpa aperiam!
                            Dignissimos sed tempore corrupti. Suscipit qui quasi consequatur temporibus.<br><br> Maxime
                            iusto reprehenderit voluptatibus adipisci ipsum libero porro laborum quo officia aliquid numquam
                            modi quisquam rerum velit ipsa tempora, eveniet totam eos, cum minus? Deserunt reprehenderit
                            nihil voluptatum eaque saepe vitae aliquam? Reiciendis eius beatae aliquid reprehenderit.</p>
                    </div>
                </div>
            </div>
        </section>
